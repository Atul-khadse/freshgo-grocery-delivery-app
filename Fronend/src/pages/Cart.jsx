...
const Cart = () => {
    ...
    const { products, cartItems, currency, removeCartItem, 
        getCartCount,updateCartItem, getCartAmount, navigate} = useAppContext();

        const [cartArray, setCartArray] = useState([]);
        // dummy Addresses add in useState from assets
        ...
        useEffect(() => {
            if(products.lenght > 0 && cartItems){
                getCart();
            }
        }, [products, cartItems]);
    ...
    return products.lenght > 0 && cartItems ? (
            ...
            <div className='flex-1 max-w-4xl'>
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        ...
                        <button onClick={() => removeCartItem()} className="cursor-pointer mx-auto">
