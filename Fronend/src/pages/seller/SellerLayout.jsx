...
const SellerLayout = () => {
   ...
   const orderIcon = (
    ...
    const sidebarLinks = [
        { name: "Addd Product", path: "/seller", icon: dashboardicon },
...
const logout = async () => {
    ...
    return (
        <>
            ...
            <div className='flex'>
                <div className="md:w-64 w-16 border-r h-[96vh] text-base border-gray-300 pt-4 flex flex-col transition-all duration-300">
